...
describe('Yup validation schemas', () => {
  describe('Email validation schema', () => {
    it('should pass with valid email', async () => {
      ...
      await expect(emailValidationSchema(initialState.strings).validate({ email: validEmail })).resolves.toEqual({
        email: validEmail,
      });
    });
    ...
    it('should fail with invalid email', async () => {
      ...
      await expect(emailValidationSchema(initialState.strings).validate({ email: invalidEmail })).rejects.toThrow();
    });
  });
  ...
  describe('Sign In Validation Schema', () => {
    it('should pass with valid email and password', async () => {
      ...
      await expect(signInValidationSchema(initialState.strings).validate(validData)).resolves.toEqual(validData);
    });

    it('should fail with invalid email or password', async () => {
      const invalidData = { email: 'invalid-email', password: 'invalid-password' };
      await expect(signInValidationSchema(initialState.strings).validate(invalidData)).rejects.toThrow();
    });
  });
  ...
  describe('Sign Up Validation Schema', () => {
    it('should pass with valid email, password, and matching confirmation', async () => {
      ...
      await expect(signUpValidationSchema(initialState.strings).validate(validData)).resolves.toEqual(validData);
    });
    ...
    it('should fail with invalid email, password, or non-matching confirmation', async () => {
      ...
      await expect(signUpValidationSchema(initialState.strings).validate(invalidData)).rejects.toThrow();
    });
  });
});
